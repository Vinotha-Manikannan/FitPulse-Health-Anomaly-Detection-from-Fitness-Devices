...
## Objective
The objective of this milestone is to develop an interactive **Health Anomaly Detection Dashboard** using Streamlit in Google Colaboratory. The dashboard enables users to:

- Upload fitness data (CSV/JSON) from wearable devices.
- Detect anomalies in health metrics such as Heart Rate, Steps, and Sleep Duration.
- Visualize trends and abnormal patterns interactively.
- Generate summary statistics and downloadable reports for further analysis.
